...
<script type="text/javascript">
      ...
      <div class="row">
        ...
        <!-- right column -->
          <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" name="category_details" action="middlepage/city_action.php" method="post">
                <!-- text input -->
                <div class="form-group">
                  <label>city name</label>
                  <input type="text" class="form-control" name="city name" onkeypress="return blockSpecialChar(event)" placeholder="Enter city name" required>
                </div>
                                  <label>State</label>
                  <?php
  ...
  event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" name="city code" placeholder="Enter city code" required>
                </div>
                  <br/>
                  <br/>
                   <div class="col-xs-4">
