  ...
  <div class="content-wrapper">
    ...
    <section>
      <div class="row">
        ...
        <!-- right column -->
          <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form  id="user_add_form" role="form" name="user_details" action="index.php?middlepage=add_new_user_action" method="post">
                <!-- text input -->
      ...
      <div class="form-group has-feedback">
        <input type="organize_name" class="form-control" placeholder="organize name" name="organize_name" required>
      ...
      <div class="form-group has-feedback col-md-11">
        <input type="text" class="form-control" placeholder="gst no" maxlength="9" minlength="9" name="gst_no" required>
      </div>
      <div class="form-group has-feedback">
 ...
 <div class="form-group col-md-14">
      ...
      <div class="form-group has-feedback col-md-14">
        ...
        ?>
          ...
          <div class="col-xs-4">
                     <button type="submit" name="submit" value="submit" onclick="return val();" class="btn btn-primary btn-block btn-flat">Submit</button>
                  </div>
                </div>
              </form>
            </div>
