<!-- Cotnent Wrapper. Contains page content -->
...
<div class="col-sm-9 col-md-10 mt-5 text-cennter">
  <form action="index.php?middlepage=user_report_action" method="POST">
    <div class="form-row">
      ...
      <div class="form-group">
          <input type="submit" class="btn  btn-primary btn-xs " name="searchsubmit" value="search">     
      </div>
    </div>   
  </form>
