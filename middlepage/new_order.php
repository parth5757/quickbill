            ...
            <div class="box-body">
              <form role="form" name="product_details" action="middlepage/new_order_action.php" method="post">
                ...
                <div class="form-group">
                  ...
                  <?php
                    $select_query=          "Select * from  user_registration WHERE user_email = '".$_SESSION['username']."'";
          ...
          <div class="box box-warning">
            ...
            <div class="box-body">
              <form role="form" name="product_details" action="middlepage/new_order_action.php" method="post">
                ...
                <div class="form-group">
                  <label>user name</label>
                  <?php
                    $select_query=          "Select * from  user_registration WHERE user_type = 3";
                    $select_query_run =     mysqli_query($conn, $select_query);
                  ?>
                  <select class="form-control" name="user_id" required>
                <?php
            ...
            <table class="table" id="dynamic_field">
              ...
              <tbody class="body_class">
                ...
                <td><input type="number" id="qty_1" class="form-control qty" data-id="1" name="quantity[]" value="1"  min="1" max="9"></td>
                <td>
                  <select class="form-control qty_type" id="qty_type_1" data-id="1" name="qty_type[]" required>
                    <!-- <option value="1">Piece</option> -->
                    <option value="2">Box</option>
