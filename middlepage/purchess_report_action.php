    ...
    <section class="content" style="padding-left: 30px;">
      <div class="row">
        ...
        <?php
            ...
            $sql_users = "SELECT * FROM purchases_master WHERE created_date BETWEEN '$startdate' AND '$enddate'";
        ...
        <?php } ?>
                  ...
                  <div>
        <input type="submit" value="print" class=" no-print" onclick="window.print()">
      </div>
    </div>
        <!-- /.card-body -->
      </div>  
