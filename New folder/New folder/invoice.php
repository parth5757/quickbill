    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            ...
            <small class="pull-right">Date: <?php echo $row->created_date; ?></small>
          </h2>
        </div>        <!-- /.col -->
      </div>
      <!-- info row -->
      <div class="row invoice-info">
        ...
        <div class="col-sm-4 invoice-col">
          <b>Invoice </b><br>
          <br>
          <b>Order ID: </b><?php echo $row->main_order_id; ?><br>
          <b>Payment Due: </b><?php echo $row->created_date; ?><br>
          ...
          <div class="table-responsive">
            <table class="table">
              <tr>
                ...
                <td>Rs. <?= number_format((float)$subtotal, 2, '.', ''); ?></td>
              </tr>
              <tr>
                <th>Shipping:</th>
                <td>Rs. 0.00</td>
