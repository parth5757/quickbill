...
if($result)
{
 ...
 while ($row = mysqli_fetch_object($result)) {
  ...
  <div class="col-md-3" style="margin-top:12px;margin-bottom:12px;">  
            <div style="border:1px solid #ccc; border-radius:5px; padding:16px; height:300px;" align="center" id="product_'.$row["product_id"].'">
             <h4 class="text-info">
                        <div class="checkbox">
                              <label><input type="checkbox" class="select_product" data-product_id="'.$row["product_id"].'" data-product_name="'.$row["product_name"].'" data-product_price="'.$row["product_name"] .'" value="">'.$row["product_name"].'</label>
                        </div>
                  </h4>
